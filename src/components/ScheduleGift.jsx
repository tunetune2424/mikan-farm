  ...
  return (
    <section id="schedule" className="schedule-gift">
      <div className="container">
        <div className="schedule-gift-grid">
          <div className="schedule-card fade-up">
          ...
          <div className="gift-card fade-up" style={{ transitionDelay: '0.1s' }}>
            <h3 className="gift-title">ギフト対応も承ります</h3>
            <div className="gift-features">
              <div className="gift-feature">
                <span className="gift-feature-icon" aria-hidden="true">🎍</span>
                <p>のし対応</p>
              </div>
              <div className="gift-feature">
                <span className="gift-feature-icon" aria-hidden="true">✉️</span>
                <p>メッセージカード<br />無料</p>
              </div>
              <div className="gift-feature">
                <span className="gift-feature-icon" aria-hidden="true">🎁</span>
            ...
            <div className="gift-image">
              <img src={giftImg} alt="ギフト用に箱詰めされたみかん" />
            </div>
            <a href="#contact" className="btn-line gift-cta">ギフトについて詳しく見る →</a>
          </div>
        </div>
      </div>
    </section>
